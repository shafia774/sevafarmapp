...
class _homepageState extends State<homepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).sevafarm,
            style: TextStyle(
                fontFamily: 'Varela',
                fontSize: 20.0,
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[GestureDetector(onTap: (){Navigator.push(context,
                        ...
                        child: _buildFruitCard(AppLocalizations.of(context).vegetables, "assets/vegetables.png", 0xffF7DFB9, 0XffFAF0DA),),
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard(AppLocalizations.of(context).fruits, "assets/fruits.png", 0xffF6E475, 0XffF9EFB0),),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap:(){Navigator.push(context,
                          ...
                          child: _buildFruitCard(AppLocalizations.of(context).cereals, "assets/cereals.png", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        Container(
                          ...
                          child: Center(
                            child: Padding(
                              ...
                              child: Column(
                                children: <Widget>[
                                  Text(AppLocalizations.of(context).seas, style: TextStyle(
                                  ...
                                  Text(AppLocalizations.of(context).kmango, style: TextStyle(
                                      fontFamily: 'OpenSans-Bold',
                                      fontWeight: FontWeight.bold,
                                      color: Colors.black,
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(AppLocalizations.of(context).seasp, style: TextStyle(
                                          color: Colors.green,
                                          fontFamily: 'OpenSans',
                                  ...
                                  //GestureDetector(
                                    ...
                                    //Fluttertoast.showToast(
                                      //msg: "AppLocalizations.of(context).ca",
                        ...
                        GestureDetector(
                          ...
                          child:_buildFruitCard(AppLocalizations.of(context).pulses, "assets/pulses.png", 0xffFFC498, 0XffFDDCC1),),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap:(){Navigator.push(context,
                          ...
                          child: _buildFruitCard(AppLocalizations.of(context).mycart, "assets/store.png", 0xffF0AEAF, 0XffF8C6CA),),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
                  ],
